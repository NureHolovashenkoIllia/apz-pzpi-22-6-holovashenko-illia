...
import ua.nure.holovashenko.flameguard_api.entity.BackupData;
import ua.nure.holovashenko.flameguard_api.entity.SystemSettings;
import ua.nure.holovashenko.flameguard_api.service.SystemSettingsService;
...
public class SystemSettingsController {
    ...
    @PreAuthorize("hasAuthority('database_admin')")
    @PostMapping("/backup")
    public ResponseEntity<Resource> createBackup(@RequestBody BackupData backupData) {
        Resource file = systemSettingsService.createDatabaseBackup(backupData.getBackupPath());
